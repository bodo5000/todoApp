<div wire:key="{{ $todo->id }}"
    ...
    <div class="flex justify-between space-x-2">
        ...
        <div class="flex items-center">
            @if ($todo->completed)
                <input wire:click="toggle({{ $todo }})" class="mr-1 self-center" type="checkbox" checked>
            @else
                <input wire:click="toggle({{ $todo }})" class="mr-1 self-center" type="checkbox">
            @endif
            ...
            @else
                <h3 class="text-lg text-semibold text-gray-800 self-center">{{ $todo->name }}</h3>
            @endif
